//
//  ImaginaryAnimalsTableViewController.swift
...
class ImaginaryAnimalsTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("ImaginaryAnimal", forIndexPath: indexPath)
        ...
        if segue.identifier == "Detail"
        {
            if let destination = segue.destinationViewController as? DetailViewController,
                indexPath = tableView.indexPathForSelectedRow {
                    destination.animal = animalsArray[indexPath.row]
            }
        }
    }
